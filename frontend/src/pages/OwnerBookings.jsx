    ...
    <div className="min-h-screen bg-gradient-light py-10 animate-fadeIn">
      <div className="max-w-6xl mx-auto px-6 md:px-10">
        <div className="mb-8 animate-fadeInUp">
          <h1 className="text-4xl font-bold gradient-primary bg-clip-text text-transparent mb-3">
            My Bookings
          </h1>
          <p className="text-gray-600 text-lg">Track and manage bookings for your listed vehicles</p>
        </div>

        {items.length === 0 && (
          <div className="card p-12 text-center shadow-md animate-scaleIn">
