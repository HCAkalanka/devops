...
function Cars() {
  ...
  return (
    <div className="min-h-screen bg-gradient-light animate-fadeIn">
      {/* Top bar */}
      <header className="sticky top-16 z-40 glass border-b border-gray-200 shadow-sm">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-12 gap-6">
        ...
        <aside className="hidden md:block md:col-span-3 animate-fadeInUp">
          <div className="card p-6 space-y-6 sticky top-28 hover-lift">
