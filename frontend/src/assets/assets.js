...
export const assets = {
    ...
    // Aliases for updated home page design
    calendar_icon: calendar_icon_colored,
    key_icon: car_icon,
    support_icon: users_icon,
    shield_icon: cautionIconColored,
    location_icon_alt: location_icon,
    money_icon: tick_icon,
    refresh_icon: arrow_icon,
    hero_bg: banner_car_image,
    addIcon,
    carIcon,
    carIconColored,
    dashboardIcon,
